...
Do not use termination phrases like 'TERMINATE'.""",
    ...
    #         "Provide constructive feedback on the file. The 'test_case_writer' will then provide a revised version.\n"
    ...
    agent_team = RoundRobinGroupChat(
       [user_proxy, TestManager, test_case_writer, bdd_coder],
       max_turns=4 # Increased max_turns to allow for review loops
    )

    try:
        # The initial task for the team.
        task = "Create a user story, acceptance criteria, test cases, and BDD stubs based on the user's requirement."
